...
Aporta evidencia empírica sobre la viabilidad de operacionalizar la Matriz de Priorización del Modelo GEMSES \citep{perez2021gemses} mediante técnicas de inteligencia artificial, ampliando el alcance del modelo desde un instrumento de gestión cualitativa hacia una herramienta de soporte automatizado a la decisión sanitaria. Constituye, hasta donde se ha podido verificar, la primera operacionalización documentada del modelo sobre un dataset clínico público de gran escala.
